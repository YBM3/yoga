     ...
     max-w-[90vw] lg:max-w-[1170px] mx-auto rounded-md h-[90px] shadow-primary px-4 lg:px-8 z-20 transition-all duration-500 flex items-center justify-between`}>
      ...
      <div className='flex items-center '>
        ...
        <div className='flex gap-x-4 lg:gap-x-9 '>
          ...
          <button className='btn btn-md lg:px-[30] bg-orange-100 border border-orange text-orange font-medium text-sm lg:text-base hover:bg-orange-200 hover:text-white transition'>
          Sign Up
          </button>
        </div>
        {/* navMobile */}
